...
/** Add Hardhat network to MetaMask if not present */
...
export async function connectWallet() {
  ...
  try {
    ...
    // Load deployed contract address from public/deployedAddress.json
    let contractAddress = DEFAULT_CONTRACT_ADDRESS;
    try {
      const res = await fetch("/deployedAddress.json");
      if (res.ok) {
